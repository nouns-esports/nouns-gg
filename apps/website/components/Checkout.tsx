...
export default function Checkout(props: {
	...
	const requiresShipping = useMemo(() => {
		return props.user.nexus?.carts.some(
			(cart) => cart.product.requiresShipping,
		);
	}, [props.user.nexus]);
	...
	const canCheckout = useMemo(() => {
		return (
			...
			(requiresShipping && !inPerson ? validShippingAddress : true)
		);
	}, [props.user.email, validShippingAddress, requiresShipping, inPerson]);
