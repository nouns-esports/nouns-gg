...
export default function Terms() {
	return (
		<div className="flex flex-col w-full items-center">
			<div
				className={twMerge(
					"flex flex-col gap-4 w-full pt-32 max-xl:pt-28 max-sm:pt-20 px-32 max-2xl:px-16 max-xl:px-8 max-sm:px-4 max-w-[1920px]",
					"prose-strong:text-white prose-strong:font-semibold prose-ul:gap-2 prose-ul:flex prose-ul:flex-col prose-table:outline prose-table:outline-1",
				)}
			>
				...
				<p>
					<strong>Last updated September 18, 2024</strong>
				</p>
				<p>
				...
				<p>
					<strong>
						We are Nouns GG LLC (&quot;Company,&quot; &quot;we,&quot;
						&quot;us,&quot; &quot;our&quot;), a company registered in New York,
						United States at 12 Gay Rd, Unit 2474, East Hampton, NY 11937.
					</strong>
				</p>
				<p>
					<strong>
						We operate the website{" "}
						<a href="https://nouns.gg">https://nouns.gg</a> (the
				...
				<p>
					<strong>
						You can contact us by email at esports@nouns.gg or by mail to 12 Gay
						Rd, Unit 2474, East Hampton, NY 11937, United States.
					</strong>
				</p>
				<p>
					<strong>
						...
						(&quot;you&quot;), and Nouns GG LLC, concerning your access to and
				...
				<p>
					...
					<br />
					<strong>9. THIRD-PARTY WEBSITES AND CONTENT</strong>
					<br />
				...
				<p>
					<strong>
						...
						in our Services, including all databases, functionality, software,
				...
				<p>
					...
					<br />
					<strong>access the Services; and</strong>
					<br />
					<strong>
				...
				<p>
					<strong>
						...
						please address your request to: esports@nouns.gg. If we ever grant
				...
				<p>
					<strong>
						A social login is required to create an account and use the Website.
						Through your Account, you will be able to view, change, or delete
						information from your Account. Your Account on nouns.gg will be
						associated with your linked blockchain address.
					</strong>
				</p>
				<p>
					<strong>
						You may only use the Website pursuant to the terms of this
						Agreement. You understand that the Website is subject to change and
						may be modified at any time without notice. The Website is provided
						AS IS, and may contain bugs, errors, or other defects. Your use of
						the Website is at your own risk. Users are solely responsible for
						their use of the Website and shall abide by, and ensure compliance
						with, all laws in connection with use of the Website, including, but
						not limited to, laws related to recording, intellectual property,
						privacy, and export control. All Users that use the Website agree to
						the terms of this Agreement.
					</strong>
				</p>
				<p>
					<strong>
						By using your wallet in connection with the Website, you agree that
						...
						maintained by, or affiliated with nouns.gg, and nouns.gg does not
						have custody or control over the contents of your wallet and has no
						ability to retrieve or transfer its contents. nouns.gg accepts no
						...
						the Website will operate with any specific wallet. You are solely
				...
				<p>
					...
					<br />
					<strong>Sell or otherwise transfer your profile.</strong>
				</p>
				<p>
					<strong>6. USER GENERATED CONTRIBUTIONS</strong>
				</p>
				...
				<p>
					<strong>
						...
						Policy:{" "}
						<a href="https://nouns.gg/privacy">https://nouns.gg/privacy</a>. By
				...
				<p>
					This Agreement will be interpreted, governed, construed, and enforced
					in accordance with the laws of the United States of America and the
					State of Delaware without giving effect to any conflicts of laws
					principles. The parties submit to and agree to personal jurisdiction
					in Delaware, with venue proper in Wilmington, Delaware.{" "}
				</p>
				<p>
					<strong>EXPECTATIONS TO ARBITRATION</strong>
				</p>
				<p>
					YOU AND NOUNS.GG AGREE THAT ARBITRATION WILL BE THE EXCLUSIVE FORUM
					AND REMEDY AT LAW FOR ANY DISPUTES ARISING OUT OF OR RELATING TO THIS
					AGREEMENT, YOUR USE OF THE WEBSITE, OR THE PURCHASE OF SERVICES FROM
					NOUNS.GG, INCLUDING ANY DISPUTES CONCERNING THE VALIDITY,
					INTERPRETATION, VIOLATION, BREACH, OR TERMINATION OF THIS AGREEMENT.
					ARBITRATION UNDER THIS AGREEMENT WILL BE HELD IN NEW YORK, NEW YORK
					AND IN ACCORDANCE WITH THE MOST RECENTLY EFFECTIVE COMMERCIAL
					ARBITRATION RULES OF THE AMERICAN ARBITRATION ASSOCIATION. THE
					ARBITRATION PROCEEDING WILL BE DECIDED BY A SINGLE ARBITRATOR AND THE
					ARBITRATOR WILL DECIDE THE ARBITRATION PROCEEDING BY APPLYING THE LAWS
					AND LEGAL PRINCIPLES OF THE STATE OF NEW YORK AND THE FEDERAL LAWS OF
					THE UNITED STATES. THE LOSING PARTY WILL BE REQUIRED TO PAY THE
					PREVAILING PARTY’S REASONABLE ATTORNEYS’ FEES. YOU AND NOUNS.GG AGREE
					THAT THE SITUS OF THIS AGREEMENT IS IN THE STATE OF DELAWARE. YOU AND
					NOUNS.GG AGREE TO SUBMIT TO THE EXCLUSIVE PERSONAL JURISDICTION OF ANY
					SUCH ARBITRATOR OR ARBITRATION PROCEEDING.
				</p>
				<p>
					<strong>16. CORRECTIONS</strong>
				</p>
				...
				<p>
					<strong>
						NOUNS.GG, AND ITS SUBSIDIARIES, AFFILIATES, THIRD PARTY LICENSORS
						AND RELATED COMPANIES, AND EACH OF ITS AND THEIR RESPECTIVE
						OFFICERS, DIRECTORS, EMPLOYEES, SHAREHOLDERS, AGENTS AND PROMOTIONAL
						AND ADVERTISING AGENCIES, SUCCESSORS, ASSIGNS (COLLECTIVELY THE
						“RELEASED PARTIES”) WILL NOT BE LIABLE TO YOU UNDER ANY LEGAL THEORY
						FOR ANY DAMAGES, CLAIMS, INJURIES, JUDGMENTS, COSTS, OR LIABILITIES
						ARISING OUT OF OR RELATED TO YOUR USE OR MISUSE OF THE WEBSITE
						INCLUDING, BUT NOT LIMITED TO, LOSS OF BUSINESS, LOSS OF INCOME,
						SPECIAL DAMAGES, INCIDENTAL DAMAGES, CONSEQUENTIAL DAMAGES, PUNITIVE
						DAMAGES, OR EXEMPLARY DAMAGES. YOU UNDERSTAND AND AGREE THAT THE
						MAXIMUM AMOUNT THAT THE RELEASED PARTIES CAN BE HELD LIABLE TO YOU
						UNDER ANY CIRCUMSTANCE IS THE AMOUNT THAT YOU PAID, IF ANY, FOR THE
						WEBSITE, AND IN NO CASE WILL THAT AMOUNT EXCEED $100. IF NO AMOUNT
						IS PAID BY YOU TO NOUNS.GG, YOU AGREE THAT YOU WILL BE LIMITED TO
				...
				<p>
					<strong>
						...
						ERRORS OR OMISSIONS. NOUNS.GG IS NOT RESPONSIBLE FOR ANY SUCH
				...
				<p>
					<strong>
						...
						DAMAGES. IF YOUR JURISDICTION DOES NOT ALLOW THE EXCLUSION OR
						LIMITATION OF DAMAGES, YOU SHOULD SEEK LEGAL COUNSEL TO UNDERSTAND
						YOUR LEGAL RIGHTS UNDER THE LAW.
					</strong>
				</p>
				<p>
					<strong>
						BY USING THIS WEBSITE, YOU ALSO AGREE TO WAIVE ANY RIGHT TO PURSUE
						LEGAL ACTION OR FILE A LAWSUIT AGAINST ROBIN ARZÓN AND VALTS
						CORPORATION ARISING FROM YOUR USE OF THE WEBSITE OR ANY INFORMATION
						OR MATERIALS AVAILABLE ON THE WEBSITE. THIS INCLUDES ANY CLAIMS
						RELATED TO YOUR NFTS, MEMBERSHIP, REWARDS, OR ANY OTHER ASPECT OF
						THE WEBSITE OR UNDERLYING SOFTWARE.
					</strong>
				</p>
				<p>
					<strong>19. INDEMNIFICATION</strong>
				...
				<p>
					<strong>Nouns GG LLC</strong>
					<br />
					<strong>12 Gay Rd</strong>
					<br />
					<strong>Unit 2474</strong>
					<br />
					<strong>East Hampton, NY 11937</strong>
					<br />
					<strong>United States</strong>{" "}
				</p>
				<p>
					<strong>esports@nouns.gg</strong>
				</p>
			</div>
		</div>
	);
