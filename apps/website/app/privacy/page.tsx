	...
	return (
		<div className="flex flex-col w-full items-center">
			...
			>
				...
				<p>
					This Privacy Notice for Nouns GG LLC (&quot;we,&quot; &quot;us,&quot;
				...
				<ul>
					<li>
						Visit our website at <a href="https://nouns.gg">https://nouns.gg</a>
				...
				<p>
					...
					have any questions or concerns, please contact us at privacy@nouns.gg.
				</p>
				...
				<p>
					The Website also utilizes Cookies. Cookies are small text files placed
					on your device to store data that can be recalled by a web server in
					the domain that placed the Cookie. We use Cookies and similar
					technologies to enable our systems to recognize your browser and to
					provide certain features. We also use “web beacons” to help deliver
					Cookies and gather usage and performance data. The Website may also
					include Cookies, web beacons, and other similar technologies from
					third-party service providers.
				</p>
				<p>
					You have a variety of tools available to control the data collected by
					...
					visit are able to use Cookies and to withdraw your consent by clearing
					or blocking Cookies. You can also stop Swagger Society from placing
					Cookies (other than those required for the Website to function) on
					your device by referencing the instructions below or opting out using
				...
				<p>
					...
					please contact us at privacy@nouns.gg.
				</p>
				<p>
				...
				<table>
					...
					<tbody>
						<tr>
							<td className="text-left">A. Identifiers</td>
				...
				<table>
					...
					<tbody>
						<tr>
							<td className="text-left">D. Commercial information</td>
							<td className="text-left">
						...
						<tr>
							<td className="text-left">E. Biometric information</td>
							<td className="text-left">Fingerprints and voiceprints</td>
							<td className="text-center">NO</td>
						</tr>
						<tr>
							<td className="text-left">
						...
						<tr>
							<td className="text-left">G. Geolocation data</td>
							<td className="text-left">Device location</td>
							<td className="text-center">NO</td>
						</tr>
						<tr>
							<td className="text-left">
						...
						<tr>
							<td className="text-left">J. Education Information</td>
							<td className="text-left">
						...
						<tr>
							<td className="text-left">L. Sensitive personal Information</td>
							<td className="text-left"></td>
							<td className="text-center">NO</td>
						</tr>
					</tbody>
				...
				<p>
					<strong>
						<em>Will your information be shared with anyone else?</em>
					</strong>
				</p>
				<p>
				...
				<p>
					...
					<a href="https://nouns.gg/discord">https://nouns.gg/discord</a>, by
					emailing us at privacy@nouns.gg, or by referring to the contact
				...
				<p>
					...
					us at privacy@nouns.gg. We will inform you in writing of any action
				...
				<p>
					...
					at privacy@nouns.gg or contact us by post at:
				</p>
				<p>
					Nouns GG LLC
					<br />
				...
				<p>
					...
					<a href="https://nouns.gg/discord">https://nouns.gg/discord</a>.
				</p>
			</div>
		</div>
	);
