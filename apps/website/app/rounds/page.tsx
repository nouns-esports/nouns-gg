...
export default async function Rounds() {
	...
	return (
		<div className="flex flex-col w-full items-center">
			<div className="flex flex-col justify-center gap-16 max-sm:gap-8 w-full pt-32 max-xl:pt-28 max-sm:pt-20 max-w-[1920px]">
				<div className="flex max-lg:flex-col max-lg:items-start max-lg:gap-4 items-center justify-between gap-16 mt-8 px-32 max-2xl:px-16 max-xl:px-8 max-sm:px-4">
					<div className="flex flex-col gap-4">
						...
						<p className="max-w-screen-sm max-lg:max-w-none">
							...
							in deciding who and what we fund, making a real impact with every
							vote. Here, anyone can submit a proposal, and everyone has the
							power to vote! By participating and supporting Nouns and our
							partners, you can level up your account, gain additional voting
							power, and unlock unique opportunities.
						</p>
					</div>
